...
<Note>
  This guide focuses on cookie-based language detection without URL routing patterns (e.g., `/en/about`). For examples with URL-based i18n routing, see the official [TanStack Router i18n example](https://github.com/TanStack/router/tree/main/examples/react/i18n-paraglide) and [TanStack Start i18n example](https://github.com/TanStack/router/tree/main/examples/react/start-i18n-paraglide).
</Note>
